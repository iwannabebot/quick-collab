        ...
        if (!this._suppress) {
            ...
            e.changes.forEach((change: editor.IModelContentChange) => {
                ...
                if (text.length > 0 && rangeLength === 0) {
                    _this._options && _this._options.onInsert && _this._options.onInsert(rangeOffset, text);
                } else if (text.length > 0 && rangeLength > 0) {
                    _this._options && _this._options.onReplace && _this._options.onReplace(rangeOffset, rangeLength, text);
                } else if (text.length === 0 && rangeLength > 0) {
                    _this._options && _this._options.onDelete && _this._options.onDelete(rangeOffset, rangeLength);
                } else {
